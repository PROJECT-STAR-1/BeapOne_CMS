          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            <thead>
              <tr className="bg-[#1B1464] text-white">
                <th className="py-5 px-6 font-bold text-sm font-instrument-sans w-1/4">
                  Tier Level
                </th>
                <th className="py-5 px-6 font-bold text-sm font-instrument-sans w-1/4">
                  Core Focus
              ...
              {TIER_MATRIX.map((row, idx) => (
                <tr
                  ...
                  className={`border-b border-gray-100 last:border-0 ${
                    idx % 2 === 0 ? "bg-[#F9FAFB]" : "bg-[#F2F3F6]"
                  }`}>
                  <td className="py-5 px-6 text-sm text-black font-medium font-instrument-sans">
                    {row.level}
                  </td>
                  <td className="py-5 px-6 text-sm text-black font-medium font-instrument-sans">
                    {row.focus}
