...
export default function HeroSection() {
  return (
    <section className="relative w-full bg-white py-16 px-6 overflow-hidden flex flex-col items-center justify-center min-h-[300px] font-instrument-sans">
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-slate-800 text-lg md:text-xl leading-relaxed mb-10">
